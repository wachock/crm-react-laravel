  ...
  return (
    <div className='mobileNav hidden-xl'>
        <nav className="navbar navbar-expand-lg navbar-dark fixed-top">
            <a className="navbar-brand" href="/worker/dashboard"><img src={logo} className='img-fluid' /></a>
            ...
            <div className="collapse navbar-collapse" id="navbarCollapse">
                <ul className="navbar-nav mr-auto">
                    <li className='nav-item'>
                        <a href="/worker/dashboard"><i className="fa-solid fa-gauge"></i>Dashboard</a>
                    </li>
                    <li className='nav-item'>
                        <a href="/worker/jobs"><i className="fa-solid fa-briefcase"></i>Jobs</a>
                    </li>
                    <li className='nav-item'>
                        <a href="/worker/schedule"><i className="fa-solid fa-video"></i>Schedule</a>
                    </li>
                    <li className='nav-item'>
                        <a href="/worker/my-account"><i className="fa-solid fa-gear"></i>My Account</a>
                    </li> 
                </ul>
