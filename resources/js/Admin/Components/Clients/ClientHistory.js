  ...
  return (
    <div className='ClientHistory'>
        <ul className="nav nav-tabs" role="tablist">
            ...
            <li className="nav-item" role="presentation"><a id="jobs-tab" className="nav-link" data-toggle="tab" href="#tab-notes" aria-selected="false" role="tab">Files</a></li>
        </ul>
        <div className='tab-content'>
            ...
            <div id="tab-notes" className="tab-pane" role="tab-panel" aria-labelledby="rejected-tab"><Files/></div>
        </div>
    </div>
  )
}
