...
export default function EditReview() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.put(`/api/admin/reviews/${params.id}`, data, { headers }).then((response) => {
            if (response.data.errors) {
                setErrors(response.data.errors);
            } else {
                alert.success("Review has been updated successfully");
                setTimeout(() => {
    ...
    const getJobs = () => {
        ...
        axios
        .get(`/api/admin/reviews/${params.id}/edit`, { headers })
        .then((response) => {
            setAuthor(response.data.review.author);
            setJob(response.data.review.job_id);
            setReview(response.data.review.review);
            setRating(response.data.review.rating);
            setDate(response.data.review.date);
        ...
        <div id="container">
            ...
            <div id="content">
                <div className="vendor-page">
                    <h1 className="page-title addReview">Edit Review</h1>
                    <form>
